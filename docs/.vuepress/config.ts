...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  locales: {
    "/": {
      ...
      title: "Sky's blog",
      description:
        "Sky's blog,专注web前端学习与总结。JavaScript,ES6,TypeScript,vue,React,css3,html5,Node,git,github等技术文章。",
    },
  },
  base: "/Blog/",
  ...
  themeConfig: {
    ...
    author: {
      name: "sky", // 必需
      link: "https://github.com/982528494", // 可选的
    },
      ...
      icons: [
        {
          ...
          title: "发邮件",
          link: "mailto:982528494@qq.com",
        },
        {
          iconClass: "icon-github",
          title: "GitHub",
          link: "https://github.com/982528494",
        },
        {
          iconClass: "icon-erji",
          title: "听音乐",
    ...
    footer: {
      ...
      copyrightInfo: ` Sky's blog| <a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>`, // 博客版权信息，支持a标签或换行标签</br>
    },
